...
- `.gemini/config/agents/orquestador.md`
- `.gemini/config/agents/product-owner.md`
- `.gemini/config/agents/planificador.md`
- `.gemini/config/agents/arquitecto.md`
- `.gemini/config/agents/buscador.md`
- `.gemini/config/agents/constructor.md`
- `.gemini/config/agents/tester.md`
- `.gemini/config/agents/control-versiones.md`
- `.gemini/config/agents/default.md`
